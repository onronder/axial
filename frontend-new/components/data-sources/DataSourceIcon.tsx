...
// OneDrive Logo SVG - cloud icon with currentColor for theme compatibility
...
// SharePoint Logo SVG - portal/document icon with currentColor for theme compatibility
