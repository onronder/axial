...
// Notion Logo SVG (official black N icon)
...
// OneDrive Logo SVG (Microsoft blue cloud)
const OneDriveIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path d="M14.763 7.865a5.402 5.402 0 0 0-4.857 3.021 4.194 4.194 0 0 0-1.623-.325 4.217 4.217 0 0 0-4.069 3.122A3.29 3.29 0 0 0 .938 16.63 3.286 3.286 0 0 0 4.22 19.92h6.81l6.893-5.07a5.416 5.416 0 0 0-3.16-6.985z" fill="#0364B8"/>
    <path d="M14.763 7.865a5.39 5.39 0 0 0-1.64.254 6.503 6.503 0 0 1 2.073 2.372 6.509 6.509 0 0 1 .717 4.36l4.408-3.24a5.416 5.416 0 0 0-5.558-3.746z" fill="#0078D4"/>
    <path d="M9.906 10.56a4.194 4.194 0 0 0-1.623-.325 4.217 4.217 0 0 0-4.069 3.122 6.5 6.5 0 0 1 4.173-2.97 6.494 6.494 0 0 1 1.519.173z" fill="#1490DF"/>
    <path d="M17.122 14.85a6.509 6.509 0 0 1-.717-4.36 6.503 6.503 0 0 0-2.073-2.371 5.39 5.39 0 0 0-4.426-.254 5.402 5.402 0 0 0-1.519 7.276l.013.02 6.893 5.07h4.028a4.314 4.314 0 0 0 2.2-8.021l-4.399 2.64z" fill="#28A8EA"/>
    <path d="M8.387 10.387a6.5 6.5 0 0 0-4.173 2.97A3.29 3.29 0 0 0 .938 16.63 3.286 3.286 0 0 0 4.22 19.92h6.81l.013-.01-2.156-2.188-6.673-4.97a3.285 3.285 0 0 1 1.572-2.765 6.494 6.494 0 0 0 4.6.4z" fill="#0078D4"/>
    <path d="M11.03 19.92h6.14l.013-.01a4.32 4.32 0 0 0 2.138-3.72 4.31 4.31 0 0 0-.2-1.34l-4.399 2.64-3.692 2.43z" fill="#14447D"/>
    <path d="M4.214 12.765a3.285 3.285 0 0 0-1.572 2.765l6.673 4.97 2.156 2.188-.013.01-2.428-1.788-6.81-5.17.013-.01a3.29 3.29 0 0 1 1.98-2.965z" fill="#0364B8"/>
  </svg>
);

// SharePoint Logo SVG (Microsoft teal S with document)
const SharePointIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <circle cx="12" cy="10" r="8" fill="#036C70"/>
    <circle cx="7" cy="17" r="5" fill="#1A9BA1"/>
    <circle cx="17" cy="17" r="4" fill="#37C6D0"/>
    <path d="M14.5 7.5c0-1.1-.5-2.1-1.3-2.8-.7-.6-1.6-.9-2.5-.7-1.8.3-3 1.9-2.7 3.7.1.6.4 1.1.8 1.5l.2.2c.5.4 1.1.6 1.7.6h.3c.4 0 .8-.1 1.2-.3.9-.4 1.6-1.2 1.9-2.1.1-.4.4-.1.4-.1z" fill="#fff"/>
    <path d="M10.7 10.2c-.7.3-1.3.8-1.7 1.4-.3.5-.3 1.1 0 1.6.2.3.5.6.9.7.4.1.8.1 1.2-.1.6-.3 1-.8 1.2-1.4.1-.3.1-.7 0-1-.2-.5-.6-.9-1.1-1.1-.2-.1-.3-.1-.5-.1z" fill="#fff"/>
  </svg>
);
