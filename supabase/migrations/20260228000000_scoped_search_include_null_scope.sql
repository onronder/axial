-- Migration: Include NULL scope_id documents in scoped search
--
-- Documents with scope_id = NULL are org-level documents without a specific scope.
-- The hybrid_search_scoped function excluded them because NULL never matches ANY().
-- This fix ensures scope-restricted viewers can still access unscoped shared documents.
