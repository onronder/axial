-- =============================================================================
-- Convert documents.source_type to TEXT for unlimited connectors
-- =============================================================================
-- Removes enum coupling so new connectors can write arbitrary source types
-- without requiring DB migrations.
-- =============================================================================

-- Drop functions that may depend on the enum return type
...
-- Ensure default remains valid after type change
ALTER TABLE documents
    ALTER COLUMN source_type SET DEFAULT 'file';

-- Drop enum type (no longer needed)
DROP TYPE IF EXISTS source_type_enum;

-- Recreate hybrid_search with TEXT source_type
...
-- Recreate match_documents with TEXT source_type
