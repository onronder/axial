...
class TeamService:
        ...
        try:
            ...
            if plan_limits.max_team_seats <= 1:
                ...
                return {
                    ...
                    "plan": "free",
                    "message": "Team access is suspended. Owner must upgrade to Enterprise."
                }
    ...
    async def get_user_team_member(self, user_id: str) -> Any | None:
        """
    ...
    async def get_user_team(self, user_id: str) -> dict[str, Any] | None:
        """
    ...
    async def get_team_by_id(self, team_id: str) -> dict[str, Any] | None:
        """
        ...
        try:
            ...
            try:
                ...
                if "P0001" in error_msg or "seat limit exceeded" in error_msg.lower():
                    ...
                    return {
                        "success": False,
                        "error": "Team seat limit reached (race condition prevented by database)",
                        "code": "SEAT_LIMIT"
                    }
