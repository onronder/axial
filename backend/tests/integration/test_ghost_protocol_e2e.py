...
class TestSmartBufferIntegration:
    ...
    def test_write_to_temp_creates_trackable_file(self, small_content):
        ...
        from services.secure_cleanup import SmartBuffer, _tracked_temp_files, secure_wipe
...
class TestEndToEndFlow:
    ...
    def test_complete_flow_simulation(self, small_content, mock_supabase):
        ...
        from services.secure_cleanup import SmartBuffer, cleanup_staging_file, secure_wipe
        from core.security import encrypt_text, decrypt_text, HAS_CHUNK_ENCRYPTION
