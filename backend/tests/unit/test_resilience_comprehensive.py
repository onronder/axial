...
class TestWithRetryDecorator:
    ...
    async def test_retries_on_transient_error(self):
        from core.resilience import with_retry, TRANSIENT_EXCEPTIONS
...
class TestWithRetrySyncDecorator:
    ...
    def test_retries_on_transient_error(self):
        from core.resilience import with_retry_sync, TRANSIENT_EXCEPTIONS
...
class TestWithRetryAsyncDecorator:
    ...
    async def test_retries_with_logging(self):
        from core.resilience import with_retry_async, TRANSIENT_EXCEPTIONS
